	...
	<nav class  = "navbar navbar-inverse">
		<div class = "container-fluid">
			<div class = "navbar-header">
				<a class = "navbar-brand">Sistem Informasi Bimbingan Belajar ACE</a>
			</div>
				...
				<table id = "table" class = "table-bordered">
					...
					<tbody>
						...
						<tr>
							...
							<td><center><a href = "group.php?club_id=<?php echo $f_query['club_id']?>" class = "btn btn-info"><span class = "glyphicon glyphicon-eye-open"></span>  Member List</a> | <a href = "club_edit.php?club_id=<?php echo $f_query['club_id']?>" class = "btn btn-warning"><span class = "glyphicon glyphicon-edit"></span>  Update</a> | <a  href = "delete_club.php?club_id=<?php echo $f_query['club_id']?>" class = "btn btn-danger"><span class = "glyphicon glyphicon-trash"></span> Delete</a></center></td>
						</tr>
						<?php
							}
						?>
...
<footer class = "navbar navbar-fixed-bottom navbar-inverse">
		<label class = "pull-right">&copy; <?php echo date('Y', strtotime('+8 HOURS'))?> Developed By: <b>Aris Sugiantoro</b></label>
	</footer>
</body>	
